...
<div class="w-full h-full flex">
    <div class="w-full flex flex-col h-screen bg-[#AED2FF]">
        <div class="h-full m-4 p-8 bg-[#EEF1FF]" rounded-lg drop-shadow-md>
            ...
            <div class="flex flex-row items-center">
                <div class="w-full h-auto flex justify-end">
                    <button><a href="{{route('download.excel')}}" class="px-4 py-2 bg-green-600 rounded-md text text-white">Download</a></button>
                </div><br>
                <div class="ml-2 h-auto flex justify-end">
                    <button><a href="{{route('admin.addDataa')}}" class="px-4 py-2 bg-green-600 rounded-md text text-white">Tambah</a></button>
                </div>
            </div>
            <br>
                    ...
                    <tbody>
                        ...
                        whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 w-40">
                                <img src="{{asset('images/barang/' . $barangs->file)}}" alt="">
                            </td>
                            <td class="px-6 py-4">
                                <div class="w-full h-auto flex gap-2 justify-center">
                                    <a href="{{route('admin.edit', $barangs->id)}}" class="p-2 bg-yellow-300 rounded-md hover:bg-yellow-400">
                                    ...
                                    <form action="{{route('admin.delete', $barangs->id)}}" method="post">
                                        @csrf
